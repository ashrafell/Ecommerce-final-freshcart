...
export default function Login() {
    ...
    return (
        <div>
            <h2 className='ms-96 fa-2x'>Login Now :</h2>
            {msg && <div className="p-4 mb-4 text-sm W-1/2 mx-auto text-red-800 rounded-lg bg-red-50" role="alert">
            ...
            <form className="max-w-md mx-auto mt-4" onSubmit={formik.handleSubmit}>
                <div className="relative z-0 w-full mb-5 group">
                    <input
                        ...
                        placeholder=" "
                    />
                    <label htmlFor="email" className="peer-focus:font-medium absolute mt-2 text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto peer-focus:text-green-600 peer-focus:dark:text-green-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">
                        Email address
                    </label>
                </div>
