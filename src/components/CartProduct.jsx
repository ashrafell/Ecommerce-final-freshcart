            ...
            <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
                ...
                <div className="mt-4 flex justify-between sm:space-y-6 sm:mt-0 sm:block sm:space-x-6">
                    <div className="flex items-center border-gray-100">
                        <button onClick={() => updateProductCount(product.product._id, product.count - 1)} disabled={product.count == 1 && isDecreaseLoading} className="cursor-pointer rounded-l bg-gray-100 py-1 px-3.5 duration-100 hover:bg-blue-500 hover:text-blue-50 disabled:hover:text-black disabled:hover:bg-white disabled:cursor-not-allowed"> {isDecreaseLoading ? <i className='fas fa-spinner fa-spin'></i> : '-'} </button>
                        ...
                        <button onClick={() => updateProductCount(product.product._id, product.count + 1)} disabled={isIncreaseLoading} className="cursor-pointer rounded-r bg-gray-100 py-1 px-3 duration-100 hover:bg-blue-500 hover:text-blue-50 disabled:cursor-not-allowed"> {isIncreaseLoading ? <i className='fas fa-spinner fa-spin'></i> : '+'} </button>
                    </div>
